...
amd64windows:
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o bili-suit-tool main.go
	tar zcvf bili-suit-tool-windows-amd64.tar.gz bili-suit-tool config.json README.md
